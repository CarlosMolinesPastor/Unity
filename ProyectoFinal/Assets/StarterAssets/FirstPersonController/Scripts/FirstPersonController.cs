...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			audioSourceMovimiento = GetComponent<AudioSource>();
		}
		...
		private void Move()
		{
			...
			if (_input.move != Vector2.zero)
			{
				...
				{
					audioSourceMovimiento.clip = _input.sprint ? audioRunning : audioWalking;
		...
		private void JumpAndGravity()
		{
			if (Grounded)
			{
				...
				if (_input.jump && _jumpTimeoutDelta <= 0.0f)
				{
					...
					// play jumping sound
					audioSourceMovimiento.clip = audioJumping;
					audioSourceMovimiento.Play();
